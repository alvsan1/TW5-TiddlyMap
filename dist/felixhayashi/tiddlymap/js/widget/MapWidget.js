...
var MapWidget = function (_Widget) {
  ...
  _createClass(MapWidget, [{
    ...
    value: function checkForFreshInstall() {
      ...
      $tm.dialogManager.open('welcome', {}, function (isConfirmed, outTObj) {

        if (_utils2.default.tiddlerExists('$:/plugins/felixhayashi/topstoryview')) {
          ...
          _utils2.default.touch('$:/plugins/felixhayashi/topstoryview');
        }
    ...
    value: function handleVisDragEnd(_ref7) {
    ...
    value: function handleVisLoading(_ref8) {
      var total = _ref8.total,
          iterations = _ref8.iterations;
    ...
    */
    ...
    value: function handleVisDragStart(_ref9) {
